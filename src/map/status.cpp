...
// ----- MISC CALCULATIONS -----
	...
	if((skill=pc_checkskill(sd,BS_SKINTEMPER))>0) {
		...
		sd->subele[ELE_EARTH] += skill;
		sd->subele[ELE_FIRE] += skill;
		sd->subele[ELE_GHOST] += skill;
		sd->subele[ELE_HOLY] += skill;
		sd->subele[ELE_NEUTRAL] += skill;
		sd->subele[ELE_POISON] += skill;
		sd->subele[ELE_UNDEAD] += skill;
		sd->subele[ELE_WATER] += skill;
		sd->subele[ELE_WIND] += skill;
